...
# Build Docker image
# ------------------
# "% nvidia-docker build -t jjleewustledu/deepmrseg_image:20220420 -f ./Dockerfile ./"
#
# Implement a quick application.
# ------------------------------
# "% nvidia-docker run -it -v $(pwd):/scratch --rm jjleewustledu/deepmrseg_image:20220420 --task dlicv --inImg fileprefix.nii.gz --outImg fileprefix_DLICV.nii.gz"
#
# will invoke the following from the within the container
# "tf-docker /scratch > deepmrseg_apply --task dlicv --inImg fileprefix.nii.gz --outImg fileprefix_DLICV.nii.gz"
...
# ---------------------------------
# "% nvidia-docker run -it -v $(pwd):/scratch --rm deepmrseg_image:20220420 --task dlicv --sList SLIST"
...
# ------------------------
# "% nvisia-docker images # to see local images"
# "% nvidia-docker push jjleewustledu/deepmrseg_image:20220420"
#
...
# "% singularity pull docker://jjleewustledu/deepmrseg_image:20220420"
# '% singularity exec --bind $(pwd):/scratch /home/aris_data/ADNI_FDG/bin/deepmrseg_image_20220420.sif "deepmrseg_apply" "--task" "dlicv" "--inImg" "/scratch/fileprefix.nii.gz" "--outImg" "/scratch/fileprefix_DLICV.nii.gz"' ### no gpu
# '% singularity exec --nv --bind $(pwd):/scratch /home/aris_data/ADNI_FDG/bin//deepmrseg_image_20220420.sif "deepmrseg_apply" "--task" "dlicv" "--inImg" "/scratch/fileprefix.nii.gz" "--outImg" "/scratch/fileprefix_DLICV.nii.gz"' ### with gpu
#
# '% singularity exec --nv --bind $(pwd):/scratch /home/aris_data/ADNI_FDG/bin//deepmrseg_image_20220420.sif "bash"' ### debug
